// ignore_for_file: file_names, camel_case_types, library_private_types_in_public_api, prefer_const_constructors, unused_local_variable, unused_element, use_build_context_synchronously
...
class _BillsUserState extends State<bills_user> {
  ...
  void _showEditDialog(String index, String name) {
    showDialog(
      context: context,
      builder: (context) {
        return AlertDialog(
